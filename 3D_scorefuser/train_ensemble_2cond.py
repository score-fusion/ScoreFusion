...
from diffusion_model.unet_brats import create_model, model_ensemble_2cond
...
def main(rank: int, world_size: int, args):
    ...
    try: 
        ...
        model_3D = create_model(input_size_model, 
            ...
            out_channels=out_channels*3 + target_channels, 
        ...
        model = model_ensemble_2cond(
            model_3D, model2D_2, model2D_3, 

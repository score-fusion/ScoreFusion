...
def main(rank: int, world_size: int, args):
    ...
    try: 
        ...
        pytorch_total_params = sum(p.numel() for p in networks_2D_3[0].parameters() if p.requires_grad)
        print("pytorch_total_params for 2D:", pytorch_total_params)
        ...
        pytorch_total_params = sum(p.numel() for p in model_3D.parameters() if p.requires_grad)
        print("pytorch_total_params for 3D:", pytorch_total_params)
        raise

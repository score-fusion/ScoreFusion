...
from diffusion_model.unet_brats import create_model, model_ensemble_three_25_model
...
def main(rank: int, world_size: int, args):
    ...
    try: 
        ...
        if len(resume_weight) > 0:
            ...
            input_size_model = 64 #input_size
        ...
        model = model_ensemble_three_25_model(model_3D, model2D_1, model2D_2, model2D_3, batch_size_2D_inference = batch_size_2D_inference, time_step=args.timesteps, baseline=args.baseline).cuda()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--port', type=int, default=15247)
    ...
    # exit()
    if args.zero_init_feature and args.baseline != "3D_feature":
        print(args.baseline)
        raise

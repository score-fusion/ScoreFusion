...
from diffusion_model.unet_brats import create_model, model_ensemble_2cond_3model
...
def ddp_setup(rank, world_size,port = 15237):
    if world_size < 4:
...
def main(rank: int, world_size: int, args):
    ...
    try: 
        ...
        model_2D_1_opt = parse_2D_config(args.model_2D_1_config, args)
        model_2D_2_opt = parse_2D_config(args.model_2D_2_config, args)
        model_2D_3_opt = parse_2D_config(args.model_2D_3_config, args)
        model_cond2_1_opt = parse_2D_config(args.model_cond2_1_config, args)
        model_cond2_2_opt = parse_2D_config(args.model_cond2_2_config, args)
        model_cond2_3_opt = parse_2D_config(args.model_cond2_3_config, args)
        ...
        #     return item_opt
        networks_2D_1 = [define_network(phase_logger, model_2D_1_opt, item_opt) for item_opt in model_2D_1_opt['model']['which_networks']]
        ...
        networks_cond2_1 = [define_network(phase_logger, model_cond2_1_opt, item_opt) for item_opt in model_cond2_1_opt['model']['which_networks']]
        networks_cond2_2 = [define_network(phase_logger, model_cond2_2_opt, item_opt) for item_opt in model_cond2_2_opt['model']['which_networks']]
        networks_cond2_3 = [define_network(phase_logger, model_cond2_3_opt, item_opt) for item_opt in model_cond2_3_opt['model']['which_networks']]

        model2D_1 = create_model_2D(
            opt = model_2D_1_opt,
            networks = networks_2D_1,
            phase_loader = [],
            val_loader = [],
            losses = [lambda x: 0],
            metrics = [lambda x: 0],
        ...
        model_cond2_1 = create_model_2D(
            opt = model_cond2_1_opt,
            networks = networks_cond2_1,
            phase_loader = [],
            val_loader = [],
            losses = [lambda x: 0],
            metrics = [lambda x: 0],
        ...
        model_cond2_2 = create_model_2D(
            opt = model_cond2_2_opt,
            networks = networks_cond2_2,
            phase_loader = [],
            val_loader = [],
            losses = [lambda x: 0],
            metrics = [lambda x: 0],
        ...
        model_cond2_3 = create_model_2D(
            opt = model_cond2_3_opt,
            networks = networks_cond2_3,
            phase_loader = [],
            val_loader = [],
            losses = [lambda x: 0],
            metrics = [lambda x: 0],
        ...
        model_3D = create_model(input_size_model, 
            ...
            out_channels=out_channels*5 + target_channels, 
            use_checkpoint = use_ckpt, 
            attention_resolutions = "",
            use_fp16=args.fp16,
            use_2D_feature = (args.baseline == "3D_feature"),
            feature_2D_channels = 256,
        ...
        model = model_ensemble_2cond_3model(
            model_3D, model2D_1, model2D_2, model2D_3, 
            model_cond2_1, model_cond2_2, model_cond2_3, 
            batch_size_2D_inference = batch_size_2D_inference, 
            time_step=args.timesteps, 
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--dataset_folder', type=str, default="Brats21")
    ...
    parser.add_argument('--model_2D_1_config', type=str, default="config/brast_SR_1_resume_3D.json")
    ...
    parser.add_argument('--model_cond2_1_config', type=str, default="config/brast_MT_1_resume_3D.json")
    parser.add_argument('--model_cond2_2_config', type=str, default="config/brast_MT_2_resume_3D.json")
    parser.add_argument('--model_cond2_3_config', type=str, default="config/brast_MT_3_resume_3D.json")
    parser.add_argument('--baseline', type=str, default="3D")
    parser.add_argument('--port', type=int, default=15237)
